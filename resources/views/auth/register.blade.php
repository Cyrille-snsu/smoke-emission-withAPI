...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Sign up - {{ config('app.name', 'Super Carry Emission Testing Co') }}</title>
            ...
            <div class="flex items-center justify-center min-h-[calc(100vh-200px)]">
                <div class="form-container">
                    <div class="form">
                        ...
                        <p class="form-subtitle">Join Super Carry Emission Testing Co to schedule smoke emission tests easily and get results digitally</p>
